...
--
-- Name: properties atomic_number_properties_elements_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT atomic_number_properties_elements_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
...
--
-- Name: properties type_id_properties_types_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT type_id_properties_types_fk FOREIGN KEY (type_id) REFERENCES public.types(type_id);
